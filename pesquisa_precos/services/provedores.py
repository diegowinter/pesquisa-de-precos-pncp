...
def listar() -> list[dict[str, Any]]:
    ...
    sondagem ao vivo (para o probe, ver `saude_provedores` em `services.execucao`)."""
...
def testar(nome: str) -> dict[str, Any]:
    ...
    sondar = (saude.sondar_health
              if any(c in ("pdf", "pareamento") for c in capacidades) else saude.sondar_url)
