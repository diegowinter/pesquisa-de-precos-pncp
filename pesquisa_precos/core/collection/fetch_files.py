...
Uso:
    python fetch_files.py --tipo contrato --cnpj 00394494000136 --ano 2026 --seq 1073
    python fetch_files.py --tipo ata --cnpj 16695025000197 --ano 2025 --seq 679 --seq-ata 1
"""
