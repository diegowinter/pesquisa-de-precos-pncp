...
""",
    ...
    Não use para a organização completa de concurso público (isso é service_selecao),
...
""",
    ...
    Não use para monitoramento por CFTV/vigilância eletrônica (isso é service_seguranca),
...
META_CATEGORIAS = {
    ...
    "testes_proficiencia": {
        ...
        "exemplos_negativos": ["ORGANIZAÇÃO DE CONCURSO PÚBLICO (service_selecao)", "CURSO DE CAPACITAÇÃO"],
    },
    "manutencao_controle_acesso": {
        ...
        "exemplos_negativos": ["MONITORAMENTO CFTV (service_seguranca)", "FORNECIMENTO DE CATRACA (sem serviço)"],
    },
    "outros": {
