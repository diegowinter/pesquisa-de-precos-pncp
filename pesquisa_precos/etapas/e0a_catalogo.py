...
Saída (nomes canônicos em config/paths.py):
...
Uso:
    python -m pesquisa_precos.etapas.e0a_catalogo                    # baixa tudo (só se faltando)
    ...
    python -m pesquisa_precos.etapas.e0a_catalogo --tipo material    # só materiais (ou 'servico')
"""
