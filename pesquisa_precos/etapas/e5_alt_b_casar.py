...
Uso: python -m pesquisa_precos.etapas.e5_alt_b_casar --provedor openrouter [--concurrency 8]
"""
...
TABELA = paths.E5ALT_TABELA
SAIDA = paths.E5ALT_ENRIQUECIDOS
DESTINO = paths.E5ALT_DESTINO
