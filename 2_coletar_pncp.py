...
Uso: python 2_coletar_pncp.py [--conceitos c1,c2] [--ignorar-cache] [--atualizar] [--limite-termos N]
"""
...
from scripts import coleta_pncp, erros_log
from scripts.coleta_pncp import COLUNAS_ITENS, FONTES
from scripts.io_seguro import EscritorSeguro, ler_chaves_concluidas

console = Console()

DATA = Path(__file__).resolve().parent / "data"
CONCEITOS = DATA / "1_conceitos_termos.csv"
SAIDA = DATA / "2_itens_coletados.csv"
ARQUIVOS_DIR = DATA / "arquivos"
CK_PROGRESSO = DATA / "checkpoints" / "2_progresso.csv"
CK_CONCEITOS_EXTRA = DATA / "checkpoints" / "2_conceitos_extra.csv"
CK_WATERMARK = DATA / "checkpoints" / "2_watermark.csv"
CK_PENDENTES = DATA / "checkpoints" / "2_pendentes.csv"
ERROS = DATA / "erros" / "2_erros.csv"
