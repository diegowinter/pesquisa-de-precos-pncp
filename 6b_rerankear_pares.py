...
GPU: o reranker roda sozinho. Uso: python 6b_rerankear_pares.py [--limite N]
"""
...
PARES = DATA / "6a_pares_candidatos.csv"
...
SAIDA = DATA / "6b_pares_rerankeados.csv"
...
def main():
    ...
    if args.remoto:
        from scripts.gpu_remoto import RerankerRemoto
        rer = RerankerRemoto(cfg["gpu_base_url"], cfg["gpu_api_key"], batch=args.batch)
    else:
        from scripts.reranker_local import RerankerLocal
