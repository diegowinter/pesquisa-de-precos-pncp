...
Uso:
  uv run python -m ferramentas.semear_prompts            # semeia (não sobrescreve se já ativo)
  uv run python -m ferramentas.semear_prompts --forcar    # sobrescreve o texto da versão 1
"""
