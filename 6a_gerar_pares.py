...
Uso: python 6a_gerar_pares.py [--sem-embedding]
"""
...
from scripts.indice_lexical import IndiceBM25
from scripts.io_seguro import ler_csv
...
EMB_CACHE = DATA / "checkpoints" / "6a_emb_cache.parquet"  # embeddings por hash de texto (reuso entre rodadas)
SAIDA = DATA / "6a_pares_candidatos.csv"
...
def main():
    ...
    if not args.sem_embedding:
        if args.remoto:
            from scripts.gpu_remoto import EmbedderRemoto
            ...
            from scripts.embedder_local import EmbedderLocal
    ...
    for categoria in categorias:
        ...
        if embedder is not None:
            from scripts.embedder_local import cosseno_linhas  # noqa: F811
