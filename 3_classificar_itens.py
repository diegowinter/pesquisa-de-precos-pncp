...
Chave de resumo: item_key. Uso: python 3_classificar_itens.py [--provedor local|openrouter] [--limite N]
"""
...
ENTRADA = DATA / "2_itens_coletados.csv"
CK_EXTRA = DATA / "checkpoints" / "2_conceitos_extra.csv"
SAIDA = DATA / "3_itens_classificados.csv"
ERROS = DATA / "erros" / "3_erros.csv"
...
def main():
    ...
    if args.retry_erros:
        ...
        from scripts.io_seguro import ler_csv, escrever_csv
