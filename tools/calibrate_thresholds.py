...
Calibração de thresholds do funil (seção 6 do guia). Duas fases:
  ...
  --amostrar   estratifica ~N pares de data/6a_pares_candidatos.csv por faixa de score e
               exporta tools/amostra_rotulagem.csv com coluna `rotulo_humano` vazia
...
Uso: python tools/calibrate_thresholds.py --amostrar [--n 180]
     python tools/calibrate_thresholds.py --analisar
"""
